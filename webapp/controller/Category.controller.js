sap.ui.define([
	...
	return Controller.extend("ui5.ShopStarWars.controller.Category", {
		...
		onListItemPress: function (oEvent) {
			...
			this.oRouter.navTo("detalleProducto", {layout: LayoutType.ThreeColumnsMidExpanded, category: this._category, product: product});
		},
		...
		_onCategoryMatched: function (oEvent) {
			...
			oTable.getItems()[oTableBindingItems.aIndices.indexOf(+oEventArgs.product)].setSelected(true);//modifica el producto con el indice que viene en argumst y modifica el selected a true
		}
	});
});